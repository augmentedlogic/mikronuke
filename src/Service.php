...
class Service {
    ...
    private $setting_app_dir = "";
    private $setting_log_dir = "";
    ...
    {
        file_put_contents(MN_LOG_DIR."/mn.log", date("Y M j G:i:s", time())." ".$msg."\n", FILE_APPEND);
    }
    ...
    {
        define("MN_LOG_DIR", $this->setting_log_dir);
