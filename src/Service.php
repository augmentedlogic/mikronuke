...
{
    // settings
    private string $setting_base_dir = '';
    private bool $setting_debugger = false;
    private ?string $setting_app_dir = null;
    private ?string $setting_log_dir = null;
    ...
    private function benchmark(): float
    {
    ...
    function __construct($routing)
    {
        ...
        $this->namesp = $routing->getNamespace();
        $this->automatic_loading = $routing->getAutomaticLoading();
    ...
    private function log(string $msg, int $level = 0): void
    {
    ...
    private function benchmark_log(string $msg): void
    {
    ...
    private function decideRoute(string $path): ?string
    {
    ...
    private function populateContext(): void
    {
        $headers = array();
        $servers = array();
